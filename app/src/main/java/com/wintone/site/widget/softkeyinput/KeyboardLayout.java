package com.wintone.site.widget.softkeyinput;
...
//            KLog.i("current layout height = " + height);

            mScreenHeight = ((WindowManager) getContext().getSystemService(Context.WINDOW_SERVICE))
                    .getDefaultDisplay().getHeight();

//            KLog.i("look at window_service height  = " + mScreenHeight);
            return mScreenHeight;
        }
        ...
        public void onGlobalLayout() {
            ...
            KLog.i("look at react height  = " + rect.bottom);
