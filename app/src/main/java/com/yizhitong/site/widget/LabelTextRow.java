package com.yizhitong.site.widget;
...
import com.yizhitong.site.utils.PhoneUtils;
    ...
    public LabelTextRow(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if(scaleLeft != INVALID && !isInEditMode()){
                ...
                final int size = com.yizhitong.site.utils.PhoneUtils.dpToPx(context, 20);
